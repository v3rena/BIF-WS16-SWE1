...
ON PRIMARY (
  Name = 'TempData_DATA',
  --Filename='C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\TempData_DATA.mdf',
...
LOG ON (
  Name = 'TempData_LOG',
  --Filename='C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\TempData_LOG.ldf',
